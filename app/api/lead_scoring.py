...
def get_active_thresholds(db: Session = Depends(get_db)):
    ...
    if not th:
        ...
        return {
            "scoring_version": "v1",
            "alpha": 0.7, "beta": 0.3,
            "fkw_min": 0.6, "fkw_max": 1.6,
            "hot_min": 80.0, "warm_min": 60.0,
    ...
    return {
        ...
        "fkw_min": float(th.fkw_min), "fkw_max": float(th.fkw_max),
        "hot_min": float(th.hot_min), "warm_min": float(th.warm_min),
